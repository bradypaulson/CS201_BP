...
- Type your answer(s) in bullet points below
  ...
  - Data Explorer, gtsummary, summarytools, forecast, desctable, dlooker, pastecs, hmisc
...
#manual colors 
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill= species))+ 
  geom_histogram(alpha= 0.75) + #alpha chnages transparency
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4"), name= "Species") +
  theme_bw()+ #chaning background
  labs(title = "Penguins Fllipper Length",
       subtitle = "3 Species Observed on Three Islands in the Palmer Archipelago",
       x = "Flipper length",
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill= species))+ 
  geom_histogram(alpha= 0.99) + #alpha chnages transparency
...
ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill= species))+ 
  ...
  labs(title = "Penguins Fllipper Length",
       ...
       x = "Flipper length",
       y = "Number of Penguins") +
  theme(axis.text = element_text(angle = 45, hjust = 1, vjust = 1), legend.position = "none" ) +
  coord_flip()
...
plotname <- ggplot(data = penguins_data, aes(x = culmen_depth_mm, fill= species))+ 
  ...
  scale_fill_viridis_d(option = "magma", name = "Species") +
  theme_bw()+ 
  labs(title = "Penguins Culmen Depth in MM",
       subtitle = "3 Species Observed on Three Islands in the Palmer Archipelago",
       x = "Culmen Depth",
       y = "Number of Penguins")
ggplotly(plotname)
...
ggplot(data = penguins_data, aes(x = culmen_depth_mm, y = body_mass_g, color= species, name = "Species"))+ 
  geom_point() +
  scale_color_viridis_d("mako") +
  labs(title = "Culmen Depth Compared To Body Mass",
       subtitle = "3 Species Observed on Three Islands in the Palmer Archipelago",
       x = "Culmen Depth",
       y = "Body Mass") +
  theme_bw()
