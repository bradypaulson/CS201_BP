...
Answer: The data set is skewed to the right. There is higher values on the right side.
...
Answer: A histogram is the count of a continuous variable. A bar chart is used for categorical data.
