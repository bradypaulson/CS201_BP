...
- mpg, cylinder, horse power, gear, weight
...
mean(mtcars$mpg) #$ lets you select variable column
...
ggplot(data = mtcars, aes(x=hp, y=qsec)) +
  ...
  theme_light() +
  labs(title = "Quarter Mile Time vs Horse Power",
       x = "Horse Power",
       y = "Time in Sec") 
